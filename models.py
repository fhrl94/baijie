...
class Empinfo(models.Model):
    ...
    Sex=models.IntegerField('性别',choices=Sex_choices,null=True)
    Nationality=models.IntegerField('民族',choices=Nationality_choice,null=True)
    BirthDate=models.DateField('出生日期',null=True)#help_text='格式规范1970-01-01'
    NativePlace=models.CharField('籍贯',max_length=50,null=True)
    PoliticsStatus=models.IntegerField('政治面貌',choices=PoliticsStatus_choice,null=True)
    MaritalStatus=models.IntegerField('婚姻状况',choices=MaritalStatus_choice,null=True)
    Tel=models.CharField('联系电话',max_length=11,validators=[RegexValidator(r'^^[\d]{11}')],unique=True)
    Email=models.EmailField('电子邮箱',max_length=50,unique=True,null=True)
    IDCardNo=models.CharField('身份证号',max_length=18,validators=[RegexValidator(r'^[\d]{17}[x,X,\d]{1}')],unique=True,null=True)
    EmergencyContactName=models.CharField('紧急联系人姓名',max_length=20,null=True)
    EmergencyContactRelation=models.IntegerField('本人与紧急联系人关系',choices=EmergencyContactRelation_choice,null=True)
    EmergencyContactTel=models.CharField('紧急联系电话',max_length=11,validators=[RegexValidator(r'^[\d]{11}')],null=True)
...
class Courseinfo(models.Model):
    ...
    StartTime=models.DateField('开始时间',)
    EndTime=models.DateField('结束时间')
    CourseLength=models.CharField('培训时长/月',max_length=3,validators=[RegexValidator(r'\d{1,3}')])
    CoursePlace=models.CharField('培训地点',max_length=50)
    DiplomaName=models.CharField('证书名称',max_length=50,null=True)
    IDCardNo=models.ForeignKey("Empinfo",on_delete=models.CASCADE,null=True)
